...
function ValueStatGetter(model, params, options) {
  ...
  function getIntervalDateFilterForPrevious() {
    ...
    params.filters.forEach(function (filter) {
      var operatorValueParser = new OperatorDateIntervalParser(filter.value, params.timezone, options);
  ...
  this.perform = function () {
    ...
    return model.unscoped().aggregate(aggregateField, aggregate, {
      ...
      if (filterDateIntervalForPrevious && params.filterType === 'and') {
        var operatorValueParser = new OperatorDateIntervalParser(filterDateIntervalForPrevious.value, params.timezone, options);
